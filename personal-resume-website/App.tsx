...
function App() {
  ...
  return (
    <div className="site-shell text-slate-700 dark:text-slate-300 font-sans leading-relaxed antialiased selection:bg-sky-300 selection:text-sky-900 dark:selection:bg-teal-300 dark:selection:text-teal-900">
      <TopNav />
      <div className="site-content mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0">
        {showSidebarHero ? (
